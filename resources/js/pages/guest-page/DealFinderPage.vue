...
const features: GuestFeature[] = [
    {
        title: 'Search the MLS Like an Investor',
        description: 'Unlike Zillow, (or the MLS) we built this platform for investors. Apply real-world filters like Flip Profit, Cash Flow, Cap Rate, and Buy Box criteria to find your next deal faster.',
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fa135d890.png',
        iframe: null
    },
    {
        title: 'Wholesale + Off-Market Inventory in One Feed',
        description: 'No more checking 5 sites and 37 emails. We bring wholesale listings from top wholesalers into one unified platform—with instant access and full deal analysis built in.',
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fa3fe7da4.png',
        iframe: null
    },
    {
        title: 'Gold Filters to Surface Hidden Gems',
        description: 'Use our Gold Filters to find undervalued or mispriced properties based on AI-analyzed deltas like Price Per SqFt, ARV gaps, and rent-to-value ratios.',
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fa57ca61a.png',
        iframe: null
    },
    {
        title: 'Alerts That Work While You Sleep',
        description: 'Save your search once, and our system will monitor the MLS and wholesale feed 24/7, pinging you the moment a match hits your criteria.',
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fa6ae2aa0.png',
        iframe: null
    }
]
...
const smartCards = [
    {
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fe8c4fd4e.png',
        title: 'Investor-Grade Filters',
        description: 'Apply filters built for real estate investors — not retail buyers. Sort by flip profit, cash flow, price per square foot, and more.',
        alt: 'Deal Intelligence Icon'
    },
    {
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fea9a71d4.png',
        title: 'Smart Deal Alerts',
        description: 'Set your Buy Box once and get notified the moment a deal hits your criteria. Sleep while your deal engine works for you.',
        alt: 'Speed & Automation Icon'
    },
    {
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fec3d3b29.png',
        title: 'MLS + Wholesale, One Feed',
        description: 'Browse both MLS and curated wholesale deals in a single interface. No more bouncing between tabs or spreadsheets.',
        alt: 'Built for Real Investors Icon'
    },
    {
        image: 'https://revamp365-storage.s3.amazonaws.com/assets/assets/6880fedd62858.png',
        title: 'Instant Deal Analysis',
        description: 'Click on any property to reveal comps, ARV, flip margins, rental ROI, and a one-click export sheet.',
...
<template>
    <GuestAppLayout>
        ...
        <div class="relative flex flex-col justify-center items-center -mt-25 pt-40 ">
            ...
            <div class="text-center max-w-4xl mx-auto mb-12 z-5 px-4">
                <h1 class="text-4xl md:text-5xl font-semibold text-white mb-6 leading-tight">
                    Deals You <span class="text-primary">Actually</span> Want.
                    
                </h1>

                <p class="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                    Find profitable on-market and off-market properties that match your strategy—automatically.
                </p>
            ...
            <!-- Announcement Bar -->
            <div
                class="bg-gray-800/80 backdrop-blur-sm border border-primary/30 rounded-full px-6 py-3 mb-8 flex items-center gap-4 mx-4 cursor-pointer" @click="router.visit(route('guest.ai_onboarding'))">
            ...
            <div class="w-full mx-auto relative bg-cover bg-center px-4"
                ...
                <div class="w-full max-w-5xl mx-auto mt-8 text-center mb-20 px-4">
                    <h2 class="text-2xl md:text-4xl font-bold text-white mb-6 leading-tight drop-shadow-sm">
                        End the endless scrolling.
                    </h2>
                    <p class="text-xl md:text-2xl text-white/95 max-w-4xl mx-auto leading-relaxed drop-shadow-sm">
                        Use Revamp 365 to instantly uncover high-ROI investment deals hidden inside the MLS and wholesale inventory.
                    </p>
                </div>
            </div>
        </div>
        ...
        <GuestAssessment />
        <GuestSmartCards 
            main-title="The right deal is already out there."
            main-description="Let us find it for you. Join Revamp365 and never miss an opportunity again."
            :cards="smartCards"
        />
        <GuestTestimonials />
        <GuestJoinFooter />
