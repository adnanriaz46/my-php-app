...
const features: GuestFeature[] = [
    {
        title: 'Find Undervalued Flip Opportunities',
        description: 'Tap into MLS and wholesale listings with smart filters like Flip Profit, Rehab Needed, and Price Per Sq Ft. Get daily alerts when a property hits your criteria.',
        image: null,
    ...
    },
    {
        ...
        description: 'No more manual spreadsheets. Instantly see ARV, rehab estimates, ROI, and cash-on-cash returns—right on the listing page.',
        image: null,
    ...
    {
        title: 'Build Offers That Win',
        description: 'Add a deal to your queue, adjust pricing with built-in guidance, and generate a signed agreement with one click. Includes due diligence protection.',
        image: null,
    ...
    },
    {
        ...
        description: 'Track your KPIs—offer-to-close ratio, zip code performance, and margin by strategy—to refine your approach and flip smarter.',
        image: null,
        iframe: '<!--ARCADE EMBED START--><div style="position: relative; padding-bottom: calc(68.28908554572271% + 41px); height: 0; width: 100%;"><iframe src="https://demo.arcade.software/k4qtBIeJvIj3mG8ddA22?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true" title="(copy) auto offers - bulk send sample" frameborder="0" loading="lazy" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="clipboard-write" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; color-scheme: light;" ></iframe></div><!--ARCADE EMBED END-->'
    }
]
        ...
        <div class="relative flex flex-col justify-center items-center -mt-25 pt-40 ">
            ...
            <div class="text-center max-w-4xl mx-auto mb-12 z-5 px-4">
                <h1 class="text-4xl md:text-5xl font-semibold text-white mb-6 leading-tight">
                    Fix & <span class="text-primary">Flip</span> Deals <br />
                    Backed by <span class="text-primary">Data</span>

                </h1>

                <p class="text-xl md:text-2xl text-white/90 mb-8 max-w-3xl mx-auto">
                    Discover profitable flip opportunities, run instant ROI analysis, and send offers—without
            ...
            <div class="w-full mx-auto relative bg-cover bg-center px-4"
                ...
                <div class="w-full max-w-5xl mx-auto mt-8 text-center mb-20 px-4">
                    <h2 class="text-2xl md:text-4xl font-bold text-white mb-6 leading-tight drop-shadow-sm">
                        Speed and Precision = Bigger Profits
                    </h2>
                    <p class="text-xl md:text-2xl text-white/95 max-w-4xl mx-auto leading-relaxed drop-shadow-sm">
                        Flipping houses is a numbers game—Revamp365 gives you an edge with real-time data, AI-driven
                        analysis, and automated offer generation. Spend less time underwriting and more time scaling
                        your business.
                    </p>
                </div>
            </div>
