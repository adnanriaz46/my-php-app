...
<template>
    <FullScreenDialog title="Comps Report" description="Comps Report" v-model="isOpen"
        ...
        <div class="w-full flex flex-col">
            ...
            <div class="h-[calc(100dvh-70px)] overflow-y-auto" v-if="!loadingAverage">
                <!-- Main Content -->
                ...
                <!-- Bottom Table -->
                <div class="flex-shrink-0 p-6 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
                ...
                <div
                    ...
                    <CompsReportDownloader ref="downloaderRef" :calculatedValues="calculatedValues ?? null"
                        :compsAverageData="compsAverageData"
                        :filteredProperties="(filteredProperties as unknown as any)" :zillowData="zillowData"
                        :arv="averageARVValue ?? 0" />
                    <Button variant="outline" class="w-full lg:w-fit" @click="askAiOpen = true">
